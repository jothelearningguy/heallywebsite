  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-blue-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto">
        ...
        >
          <h1 className="text-4xl font-bold text-gray-900 mb-4">Invest in the Future of Learning</h1>
          <p className="text-xl text-gray-600">Join us in revolutionizing education through AI-powered personalized learning</p>
        </motion.div>
